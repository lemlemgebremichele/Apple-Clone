...
class Rating extends Component {
  ...
  render() {
      return (
        <div>
          <h2>Please Rate Your Experiance</h2>
          <button class="btn1" onClick={this.increment}>
            Increment
          </button>
          <button class="btn2" onClick={this.decrement}>
            Decrement
          </button>
          {/* <div>Your Rate Is : {this.state.value}</div> */}
          <button class="btn3"> Your Rate Is : {this.state.value}</button>
        </div>
      );
  }
}
